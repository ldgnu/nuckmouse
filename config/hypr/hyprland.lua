...
-- Resize
hl.bind(M .. " + CTRL + H", hl.dsp.window.resize({ x = -10, y = 0 }))
hl.bind(M .. " + CTRL + J", hl.dsp.window.resize({ x = 0, y = 10 }))
hl.bind(M .. " + CTRL + K", hl.dsp.window.resize({ x = 0, y = -10 }))
hl.bind(M .. " + CTRL + L", hl.dsp.window.resize({ x = 10, y = 0 }))
