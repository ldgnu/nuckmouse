...
-- Resize
hl.bind(M .. " + CTRL + H", hl.dsp.exec_cmd("hyprctl dispatch resizeactive -10 0"))
hl.bind(M .. " + CTRL + J", hl.dsp.exec_cmd("hyprctl dispatch resizeactive 0 10"))
hl.bind(M .. " + CTRL + K", hl.dsp.exec_cmd("hyprctl dispatch resizeactive 0 -10"))
hl.bind(M .. " + CTRL + L", hl.dsp.exec_cmd("hyprctl dispatch resizeactive 10 0"))
...
hl.define_submap("resize", function()
  hl.bind("H",       hl.dsp.exec_cmd("hyprctl dispatch resizeactive -10 0"))
  hl.bind("J",       hl.dsp.exec_cmd("hyprctl dispatch resizeactive 0 10"))
  hl.bind("K",       hl.dsp.exec_cmd("hyprctl dispatch resizeactive 0 -10"))
  hl.bind("L",       hl.dsp.exec_cmd("hyprctl dispatch resizeactive 10 0"))
  hl.bind("left",    hl.dsp.exec_cmd("hyprctl dispatch resizeactive -10 0"))
  hl.bind("down",    hl.dsp.exec_cmd("hyprctl dispatch resizeactive 0 10"))
  hl.bind("up",      hl.dsp.exec_cmd("hyprctl dispatch resizeactive 0 -10"))
  hl.bind("right",   hl.dsp.exec_cmd("hyprctl dispatch resizeactive 10 0"))
